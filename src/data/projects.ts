...
export const PROJECTS: Project[] = [
  {
    ...
    dado: "Sintético",
    description: "Reclamações no formato da ANATEL em star schema, com 50 medidas DAX e camada visual gerada por código. Normaliza volume por base de assinantes: a SERCOMTEL reclama 4× mais por assinante que a CLARO.",
