...
export const PROJECTS: Project[] = [
  {
    ...
    dado: "Sintético",
    description: "Reclamações da ANATEL em star schema, com 53 medidas DAX, RLS por operadora e o mesmo dado reprocessado como Lakehouse medallion no Microsoft Fabric, em Direct Lake. A SERCOMTEL reclama 4× mais por assinante que a CLARO.",
    tags: ["Power BI", "DAX", "Star Schema", "Microsoft Fabric"],
    githubUrl: "https://github.com/HugoLeonardoNz/telecom-powerbi-public",
    liveUrl: "https://app.fabric.microsoft.com/view?r=eyJrIjoiMzhiZjcyOTctMzI5OC00NTJlLTg3OWYtNzg1NjZiNjg0ODI4IiwidCI6IjA5NGFkODdhLTAzNDMtNGU3OC05NmIzLTE2OGI4ZTVmMjgzMSJ9",
  ...
  },
  {
    ...
    liveUrl: "https://app.fabric.microsoft.com/view?r=eyJrIjoiZjYxZTZkY2YtYTJhNC00ZWU0LWEyNTktMTc0MzczMTExNGQwIiwidCI6IjA5NGFkODdhLTAzNDMtNGU3OC05NmIzLTE2OGI4ZTVmMjgzMSJ9",
  ...
  },
  {
    ...
    description: "Plataforma de dashboards que substituiu o Power BI da operação: 12 painéis sobre FastAPI, MongoDB e React, ETLs agendados contra o ERP, acesso por nível e por tag, e mais de 600 testes que travam regressão de número.",
  ...
  },
  {
    ...
    dado: "IBGE · observado",
    description: "Onde um ISP deve expandir por lacuna de acesso — e por que a pergunta venceu. O corte de 92% deixava 13 estados na fila em 2023 e deixa um em 2025: o indicador parou de discriminar antes de haver resposta.",
  ...
  },
  {
    ...
    tipo: "EDA sobre 15,9 M de linhas",
    dado: "ANATEL · observado",
    description: "18,8 milhões de solicitações reais do regulador, 2015–2020. Três hipóteses refutadas: quem lidera é a OI, não a CLARO; o canal já não é o telefone; e o problema é cobrança, não falha técnica.",
    tags: ["Python", "Pandas", "EDA", "Dado aberto"],
